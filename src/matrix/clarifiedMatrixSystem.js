/**
 * Clarified Matrix System - Clear distinction between token percentages vs vote trading
 * Fixes potential confusion about what OFFERS and REQUESTS represent
 */

const { callLLM } = require('../core/llmApi');

class ClarifiedMatrixSystem {
    constructor() {
    ...
    initializeMatrix(players) {
        ...
        console.log(`🔢 Initialized ${numPlayers}x${matrixWidth} matrix with clarified vote/token distinction`);
    ...
    async performNegotiationRound(playerIndex, strategy, roundNumber) {
        ...
        try {
            ...
            console.log(`🔢 [${playerName}] Updating matrix row ${playerIndex} (clarified prompt)...`);
...
Your strategic analysis and matrix update:`;
    ...
    displayResults() {
        console.log('\n📊 CLARIFIED MATRIX SYSTEM RESULTS');
        console.log('==================================');
        
        console.log('MATRIX STATE (with clear token/vote labels):');
...
module.exports = { ClarifiedMatrixSystem }; 